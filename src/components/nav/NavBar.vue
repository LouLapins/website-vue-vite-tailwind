<template>
  <header class="left-0 z-10 w-screen stop-0 lg:relative bg-zinc-900">
    <nav class="flex items-center justify-between">
      ...
      <div :class="showMobileMenu ? 'visible' : 'invisible'"
        ...
        <NavItem class="lg:invisible" to-component-name="Home" text="Home">
        </NavItem>
        <NavItem class="mt-8 lg:mt-0" v-for="item in navItems" :to-component-name="item.componentName" :text="item.text" />
      </div>
    </nav>
  </header>
</template>
